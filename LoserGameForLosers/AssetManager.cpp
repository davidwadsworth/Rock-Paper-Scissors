...
Entity* AssetManager::create_option_box(int options_id, Vector2D position, const int input_id) const
{
	...
	option_box.add_component<ControllerComponent>(controller_options, input_id);
...
Entity * AssetManager::create_left_player(int controller_id) const 
{
...
Entity * AssetManager::create_right_player(int controller_id) const
{
