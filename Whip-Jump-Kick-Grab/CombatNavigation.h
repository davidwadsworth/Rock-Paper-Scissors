...
namespace Navigation
{
	...
	class ActivateAI : public Navigator
	{
		Entity * bot_;
	public:
		ActivateAI(Entity * bot)
			: bot_(bot)
		{}
	...
	class DeactivateAI : public Navigator
	{
		Entity * bot_;
	public:
		DeactivateAI(Entity * bot)
			: bot_(bot)
		{}
		int choose_path() override;
	};

	class SelectAttackAI : public Navigator
	{
		Entity * bot_;
	public:
		SelectAttackAI(Entity * bot)
			: bot_(bot)
		{}
